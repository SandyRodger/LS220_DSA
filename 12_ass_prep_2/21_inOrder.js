...
- Go left as far as we can
  ...
  - while curr.left
    ...
    - curr = curr.left
- when we reach the node with no further left, put that value in the output
- The parent of the node we just took will now be taken
- If that node has a right put that on the stack
