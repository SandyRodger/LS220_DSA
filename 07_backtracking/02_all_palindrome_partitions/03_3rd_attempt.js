...
PARTITIONS:
  ...
  - thery used this word on purpose. Your logic should focus on that. I give you a fish, how will you chop it up. Very good. Here is another fish, can you chop it differently?

A:

while max palindrome is <= input.length (maxPaliLength)
  - take the word, left to right (idx)
    - look for maxLengthPalis
      - max = maxLengthPalis
      - iterate through taking valid palis of max length
        - base case is empty input
        - when you take it pass the left remainder and right remainder into recursive method
        - if there is no remainder then decrement the max length pali
